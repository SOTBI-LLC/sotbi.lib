...
type ExcelGeneralRequest struct {
	...
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	Items         *structpb.ListValue    `protobuf:"bytes,5,opt,name=items,proto3" json:"items,omitempty"`
...
var file_api_excel_gen_excel_gen_proto_rawDesc = string([]byte{
	...
	0x74, 0x12, 0x30, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
